...
class GeneratorScreen(val playerInventory: PlayerInventory, val generatorBlockEntity: GeneratorBlockEntity) : HandledScreen(
    ...
    override fun render(mouseX: Int, mouseY: Int, delta: Float) {
        ...
        additions.tooltip(this, listOf("${if (generatorBlockEntity.energy < generatorBlockEntity.energyCapacity / 5) Formatting.RED else Formatting.AQUA}${generatorBlockEntity.energy}${Formatting.FORMATTING_CODE_PREFIX}r/${Formatting.AQUA}${generatorBlockEntity.energyCapacity} EU"), euTooltipRect, mouseX, mouseY)
    }
    ...
    override fun drawBackground(tickDelta: Float) {
        ...
        additions.drawImage(this, "/assets/glasstech/stationapi/textures/gui/energy_bar.png", 82, 12, (generatorBlockEntity.energy.toFloat() / generatorBlockEntity.energyCapacity))
