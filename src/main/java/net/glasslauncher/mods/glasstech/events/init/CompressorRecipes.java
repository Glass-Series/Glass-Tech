...
//        registry.register(NAMESPACE.id("plantball2compressedplant"), new BasicMachineRecipe(new StackRecipeInput(new ItemStack(GlassTechItems.plantBall)), 200, new RecipeOutput(new ItemStack(GlassTechItems.compresedPlants))));
...
//        registry.register(NAMESPACE.id("hydratedcoaldust2hydratedcoalball"), new BasicMachineRecipe(new StackRecipeInput(new ItemStack(GlassTechItems.hydratedCoalDust)), 200, new RecipeOutput(new ItemStack(GlassTechItems.hydratedCoalBall))));
