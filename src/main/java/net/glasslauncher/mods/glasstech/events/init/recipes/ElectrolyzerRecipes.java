...
public class ElectrolyzerRecipes {
    public static void initRecipes() {
        ...
        registry.register(NAMESPACE.id("electrolyzewater"), new ElectrolyzerMachineRecipe(new StackRecipeInput(new ItemStack(GlassTechItems.waterCell)), new RecipeOutput(new ItemStack(GlassTechItems.electrolyzedWaterCell)), -20000));
        registry.register(NAMESPACE.id("unelectrolyzewater"), new ElectrolyzerMachineRecipe(new StackRecipeInput(new ItemStack(GlassTechItems.electrolyzedWaterCell)), new RecipeOutput(new ItemStack(GlassTechItems.waterCell)), 18000));
    }
}
