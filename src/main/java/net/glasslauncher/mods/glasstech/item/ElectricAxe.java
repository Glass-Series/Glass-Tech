...
public class ElectricAxe extends TemplateAxeItem implements GTEnergyStorageItem, GTEnergyBar {
    @Setter
    protected int maxEnergy;
    @Setter @Getter
    protected VoltageTier voltageTier;

    public ElectricAxe(Identifier identifier, ToolMaterial toolMaterial, VoltageTier voltageTier, int maxEnergy) {
