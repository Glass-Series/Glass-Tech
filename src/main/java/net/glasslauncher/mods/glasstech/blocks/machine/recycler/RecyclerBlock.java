...
public class RecyclerBlock extends MachineBlockTemplate {

    public RecyclerBlock(Identifier identifier, Material material) {
    ...
    public boolean onUse(World world, int x, int y, int z, PlayerEntity player) {
        RecyclerBlockEntity recyclerBlockEntity = (RecyclerBlockEntity) world.getBlockEntity(x, y, z);
        GuiHelper.openGUI(
                player,
                GlassTech.NAMESPACE.id("recycler"),
                recyclerBlockEntity,
                new RecyclerScreenHandler(player.inventory, recyclerBlockEntity)
        );
        return true;
    }
}
