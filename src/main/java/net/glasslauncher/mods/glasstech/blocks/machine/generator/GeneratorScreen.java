...
public class GeneratorScreen extends HandledScreen {
    ...
    public void drawBackground(float tickDelta) {
        ...
        glassguis_drawImagePercentage(this, "/assets/glasstech/stationapi/textures/gui/energy_bar.png", 82, 12, (((float) generatorBlockEntity.getEnergyStored()) / generatorBlockEntity.getEnergyCapacity()), DrawDirection.RIGHT);
        ...
        glassguis_drawImagePercentage(this, "/assets/glasstech/stationapi/textures/gui/flame_fg.png", 80, 40, generatorBlockEntity.getInitialFuelTicks() <= 0 ? 0 : generatorBlockEntity.getFuelTicks() / (float) generatorBlockEntity.getInitialFuelTicks(), DrawDirection.UP);
